...
public class EditTodoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (todoId!=-1){
            ...
            ETodo todo = tdlTodoViewModel.getTodoById(todoId);
    ...
    void DisplayAlerDialog(){
        tdlAlterDialog = new AlertDialog.Builder(getContext());
        tdlAlterDialog.setMessage(getString(R.string.edit_cancel_promt))
                .setCancelable(false)
